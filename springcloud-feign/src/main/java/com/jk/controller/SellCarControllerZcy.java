...
public class SellCarControllerZcy {
    ...
    @ResponseBody
    public void addSellCar(CarBean bean){
        System.out.println(bean.getBrandid());
        System.out.println(bean.getSeriesid());
        System.out.println(bean.getSptimeid());
        System.out.println(bean.getSptimemonthid());
        System.out.println(bean.getMileage());
        System.out.println(bean.getPlataid());
        System.out.println(bean.getChekuang());
        System.out.println(bean.getYanchetime());
        System.out.println(bean.getYanchedz());
    }
